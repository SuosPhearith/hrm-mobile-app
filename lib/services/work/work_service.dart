...
class CreateWorkService {
  ...
  Future<ResponseStructure<Map<String, dynamic>>> getUserFamilyById({
    required String familyId,
    required String userId
  }) async {
    try {
      final response =
          await DioClient.dio.get("/account/profile/$userId/user_family/$familyId");
      return ResponseStructure<Map<String, dynamic>>.fromJson(
        response.data as Map<String, dynamic>,
        dataFromJson: (json) => json,
      );
  ...
  Future<Map<String, dynamic>> updateUserFamily({
    ...
    try {
      final response = await DioClient.dio.put(
        "/account/profile/$userId/user_family/$familyId",
        data: {
          "name_kh": nameKh,
          "name_en": nameEn,
          "sex_id": sexId,
  ...
  Future<ResponseStructure<Map<String, dynamic>>> getUserEducationById({
    required String educationId,
    required String userId
  }) async {
    try {
      final response =
          await DioClient.dio.get("/account/profile/$userId/user_education/$educationId");
      return ResponseStructure<Map<String, dynamic>>.fromJson(
        response.data as Map<String, dynamic>,
        dataFromJson: (json) => json,
      );
  ...
  Future<Map<String, dynamic>> updatedUserEducation({
    required String userId,
    required String educationId,
    required String educationTypeId,
    required String educationLevelId,
    ...
    try {
      final response = await DioClient.dio.put(
        "/account/profile/$userId/user_education/$educationId",
        data: {
          "education_type_id": educationTypeId,
          "education_level_id": educationLevelId,
          "certificate_type_id": certificateTypeId,
  ...
  Future<ResponseStructure<Map<String, dynamic>>> getUserLanguageById({
    required String languageId,
    required String userId
  }) async {
    try {
      final response =
          await DioClient.dio.get("/account/profile/$userId/user_language/$languageId");
      return ResponseStructure<Map<String, dynamic>>.fromJson(
        response.data as Map<String, dynamic>,
        dataFromJson: (json) => json,
      );
  ...
  Future<Map<String, dynamic>> updateUserLanguage({
    ...
    try {
      final response = await DioClient.dio.put(
        "/account/profile/$userId/user_language/$userLanguageId",
        data: {
          "language_id": int.tryParse(languageId) ?? 0,
          "speaking_level_id": int.tryParse(speakingLevelId) ?? 0,
          "writing_level_id": int.tryParse(writingLevelId) ?? 0,
