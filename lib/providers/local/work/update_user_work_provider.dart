...
class UpdateUserWorkProvider extends ChangeNotifier {
  // Feilds
  ...
  // Initialize
  UpdateUserWorkProvider({required String userId, required String workId}) {
  ...
  Future<void> getHome({String? workId, String? userId}) async {
    ...
    try {
      ...
      final res =
          await _service.getUserWorkById(workId: workId!, userId: userId!);
      _dataSetup = resSetUp;
