...
class _CreateWorkHistoryScreenState extends State<CreateWorkHistoryScreen> {
  ...
  String? selectedEducationrankPossitionId;
  String? selecteddepartmentId;
  String? selectedCertificaterankPossitionId;
  ...
  void _handleSubmit() async {
    ...
    String? getFirstValidationError() {
      if (selectedEducationrankPossitionId == null || selectedEducationrankPossitionId!.isEmpty) {
        return 'Please select education rankPossition';
      }
    ...
    showConfirmDialogWithNavigation(
      ...
      try {
        ...
        //   userId: widget.id ?? '',
        //   educationrankPossitionId: selectedEducationrankPossitionId!,
        //   departmentId: selecteddepartmentId!,
        //   certificaterankPossitionId: selectedCertificaterankPossitionId ?? '',
        //   majorId: selectedMajorId ?? '',
        //   possitionId: selectedpossitionId ?? '',
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        ...
        child: Consumer2<CreateEducationProvider, SettingProvider>(builder:
          ...
          final educationrankPossitions = _buildEducationSelectionMap(
            apiData: createEducationProvider.data,
            dataKey: 'education_rankPossitions',
            settingProvider: settingProvider,
          );

          final departments = _buildEducationSelectionMap(
            apiData: createEducationProvider.data,
            dataKey: 'education_levels',
            settingProvider: settingProvider,
          );

          final certificaterankPossitions = _buildEducationSelectionMap(
              apiData: createEducationProvider.data,
              dataKey: 'certificate_rankPossitions',
              settingProvider: settingProvider);
          final majors = _buildEducationSelectionMap(
              apiData: createEducationProvider.data,
              dataKey: 'majors',
              settingProvider: settingProvider);
          final possitions = _buildEducationSelectionMap(
              apiData: createEducationProvider.data,
              dataKey: 'possitions',
              settingProvider: settingProvider);
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                            ...
                            // Education rankPossition
                            _buildSelectionField(
                              controller: _rankPossition,
                              label:
                                  '${AppLang.translate(lang: settingProvider.lang ?? 'kh', key: 'user_education_rankPossition')} *',
                              items: educationrankPossitions,
                              selectedId:
                                  selectedEducationrankPossitionId, // Pass current selection
                              onSelected: (id, value) {
                                setState(() {
                                  selectedEducationrankPossitionId = id;
                            ...
                            _buildSelectionField(
                              ...
                              label:
                                  '${AppLang.translate(lang: settingProvider.lang ?? 'kh', key: 'user_department')} *',
                              items: departments,
                              selectedId:
                            ...
                            _buildSelectionField(
                              ...
                              items: certificaterankPossitions,
                              selectedId:
                                  selectedCertificaterankPossitionId, // Pass current selection
                              onSelected: (id, value) {
                                setState(() {
                                  selectedCertificaterankPossitionId = id;
